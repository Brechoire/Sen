...
urlpatterns = [
    ...
    path(
        "boutique/remboursements/<int:refund_id>/traiter/",
        views.process_refund,
        name="process_refund",
    ),
    path("boutique/fidelite/", views.manage_loyalty_programs, name="loyalty_programs"),
    path(
        "boutique/fidelite/creer/",
        views.create_loyalty_program,
        name="create_loyalty_program",
    ),
    path(
        "boutique/fidelite/<int:program_id>/toggle/",
        views.toggle_loyalty_program,
        name="toggle_loyalty_program",
    ),
    path(
        "boutique/fidelite/<int:program_id>/supprimer/",
        views.delete_loyalty_program,
        name="delete_loyalty_program",
    ),
    path("boutique/codes-promo/", views.manage_promo_codes, name="promo_codes"),
    path(
        "boutique/codes-promo/creer/", views.create_promo_code, name="create_promo_code"
    ),
    path(
        "boutique/codes-promo/<int:code_id>/toggle/",
        views.toggle_promo_code,
        name="toggle_promo_code",
    ),
    path(
        "boutique/codes-promo/<int:code_id>/supprimer/",
        views.delete_promo_code,
        name="delete_promo_code",
    ),
    path(
        "boutique/statuts-fidelite/", views.manage_loyalty_status, name="loyalty_status"
    ),
    path("categories/", views.manage_categories, name="categories"),
    path("categories/creer/", views.create_category, name="create_category"),
    path(
        "categories/<int:category_id>/modifier/",
        views.edit_category,
        name="edit_category",
    ),
    path(
    ...
    path(
        "categories/<int:category_id>/supprimer/",
    ...
    path(
        ...
        views.environment_variables,
        name="environment_variables",
    ),
    # Actions sur les articles
    path(
        "articles/<int:article_id>/toggle/",
    ...
    path(
        "livres/<int:book_id>/marquer-disponible/",
        views.mark_book_available,
        name="mark_book_available",
    ),
    # Actions sur les auteurs
    path(
        "auteurs/<int:author_id>/toggle/",
        views.toggle_author_status,
        name="toggle_author",
    ),
    # Actions sur les avis
    path(
        "avis/<int:review_id>/approuver/", views.approve_review, name="approve_review"
    ),
    ...
    path(
        "commande/<int:order_id>/suivi/",
        views.update_tracking_info,
        name="update_tracking_info",
    ),
    path(
        "commande/<int:order_id>/paiement/",
        views.update_payment_status,
        name="update_payment_status",
    ),
    path("commande/<int:order_id>/annuler/", views.cancel_order, name="cancel_order"),
    # Sauvegardes
    path("sauvegardes/", views.backup_management, name="backups"),
    path(
        "sauvegardes/telecharger/<str:backup_name>/",
