...
urlpatterns = [
    ...
    path(
        "admin/livre/ajouter/", views.redirect_to_admin_create_book, name="book_create"
    ),
    path(
        "admin/livre/<slug:slug>/modifier/",
        views.redirect_to_admin_books,
        name="book_update",
    ),
    path(
        "admin/livre/<slug:slug>/supprimer/",
        views.redirect_to_admin_books,
        name="book_delete",
    ),
    ...
    path(
        "admin/categorie/<slug:slug>/modifier/",
        views.CategoryUpdateView.as_view(),
        name="category_update",
    ),
    path(
        "admin/categorie/<slug:slug>/supprimer/",
    ...
    path(
        "panier/supprimer/<int:book_id>/",
        views.remove_from_cart,
        name="remove_from_cart",
    ),
    path(
        "panier/modifier/<int:book_id>/",
        views.update_cart_item,
        name="update_cart_item",
    ),
    path(
        "panier/diminuer/<int:book_id>/",
    ...
    path(
        "api/code-promo/supprimer/", views.remove_promo_code, name="remove_promo_code"
    ),
    ...
    path(
        "commande/<int:order_id>/remboursement/",
    ...
    path(
        "paiement/paypal/<int:order_id>/", views.paypal_payment, name="paypal_payment"
    ),
    ...
    path(
        "paiement/manuel/<int:order_id>/", views.manual_payment, name="manual_payment"
    ),
    # API PayPal
    path(
